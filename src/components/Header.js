...
const Header = ({ currentLive, setCurrentLive, setPreviousLive }) => {
  ...
  return (
    <nav className='bg-white w-full pt-1'>
      <div className='container grid justify-items-center'>
        ...
        <div
          className='flex flex-wrap justify-around text-center font-semibold text-sm w-full 
